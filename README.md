...
<h3 align="center">Я начинающий продуктовый аналитик </h3>

Приветствую Вас в моем портфолио!
Здесь я собрал проекты, которые я выполнял, в области продуктовой и бизнес аналитики, машинного обучения, а также моделировании и анализа бизнес-процессов в компании.
